...
#HyperParameters
bacth_size = 64    # How many independent sequences will we process in parallel?
...
decode = lambda l: ''.join()([itos[i] for i in l])  #decode: take list of ints, output string
...
class MultiHeadAttention(nn.Module):
    ...
    def __init__(self, nums_head, head_size, n_embd, dropout):
        super().__init__()
